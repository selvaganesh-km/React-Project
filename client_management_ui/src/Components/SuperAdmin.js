  ...
  const clientLogin = async (e) => {
    ...
    try {
      ...
      if (response.ok && responseData.apiStatus.code === "200") {
        ...
        localStorage.setItem("superName", responseData.responseData.userDetail.userName);
                    ...
                    <div class="card-body">
                      ...
                      {loading ? (
                        ...
                        <p class="text-center small">
                          ...
                          <div class="col-12">
                            <button style={{ marginTop: "30px" }} onClick={clientLogin} class="btn btn-primary w-100">
