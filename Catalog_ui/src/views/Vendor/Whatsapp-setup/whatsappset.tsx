        ...
        <>
            <DashboardLayout>
                            ...
                            {loading ? (
                                ...
                                <div className="col-md-7">
                                    <div className="campaign-template">
                                        <h6 className="campaign-temp-head tblName">Connect WhatsApp Manually</h6>
                                        <div className="campaign-template border mt-5  shadow-lg mb-5 ">
                                            <h6 onClick={ShowTernary} className="campaign-temp-head tblName">Facebook Developer Account & Facebook App <span className="setting-whatsapp-ternary" >Click to expand/collapse</span></h6>
                                        ...
                                        <div className="campaign-template border mt-5  shadow-lg mb-5 ">
                                            <h6 onClick={ShowButtonData1} className="campaign-temp-head tblName">WhatsApp Integration Setup  <span className="setting-whatsapp-ternary" > Click to expand/collapse</span></h6>
                                    ...
                                    <div className="campaign-template mt-4">
                                        <h6 className="campaign-temp-head tblName">Access Token Information</h6>
                                        <div>
                                    ...
                                    <div className="campaign-template border mt-5 shadow-lg mb-5">
                                    <h6 className="campaign-temp-head tblName" onClick={ShowButtonDatas}>
                                ...
                                <div className="col-md-5">
                                    <div className="campaign-template">
                                        <h6 className="campaign-temp-head tblName">Default Phone Number</h6>
                                        <div className="campaign-template border mt-5  shadow-lg mb-5 ">
                                            <h6 className="campaign-temp-head tblName">Phone Numbers</h6>
                                            {whatsappInte? 
                                            <div className="p-3">
              ...
              data-bs-target="#vendorview" onClick={handlewhatsappbussinessInfo}><i className="fa-solid fa-pen"></i> Update Bussiness Profile</button>
                                        ...
                                        <>
                                        <div className="campaign-template border mt-5  shadow-lg mb-5 ">
                                            <h6 className="campaign-temp-head tblName">Overall Health </h6>
                                            <div className="p-3">
                                        ...
                                        <>
                                        <div className="campaign-template border mt-5  shadow-lg mb-5 ">
                                            <h6 className="campaign-temp-head tblName">{listData?.entity_type} - {listData?.id}</h6>
                                            <div>
                                        ...
                                        <div className="modal-content all-modal-content vendorcreate-modal-content">
                                            ...
                                            <div className="p-0 modal-body text-center ">
                                                ...
                                                <div className="text-start ms-4 mx-4 campaign-template">
                                                    <h6 className="campaign-temp-head tblName text-center">New Profile Image</h6>
                                                    <div className="row">
