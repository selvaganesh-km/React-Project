    ...
    useEffect(() => {
       ...
       const handleOrderListAPI = (page: any, catalogId: any,search:any) => {
        ...
        //    search:search,
           ...
           VendorAPI.OrderPendingAPI(apiData)
              .then((responseData: any) => {
                  if (responseData.apiStatus.code === '200') {
                      setLoading(false)
            ...
            <DashboardLayout>
                    ...
                    <div className="row vendor-breadcrumbs container-fluid py-1 px-3">
                        <div className="col-md-6">
                            <nav aria-label="breadcrumb">
                                ...
                                <h6 className="text-start font-weight-bolder mb-0 grayFont">Pending Order</h6>
                            </nav>
                        </div>
                                                            ...
                                                            <td className="action-buttons">
                                                              {/* <div className="actionChangeStatus-tooltip-container cursor-pointer"  onClick={() => toggleDropdown(listData.id)}>
                                                                <span className="ms-2 position-relative dropdown-wrapper" >
                                                                    ...
                                                                    <div className="actionView-tooltip-container cursor-pointer" onClick={()=> {
                                                                        setOrderID({
                                                                            id: listData?.id,
                                                                            name: listData?.name,
                                                                            qty: listData?.qty,
                ...
                <div className="modal fade" id="exampleModal"   role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <div className="modal-header d-flex justify-content-between border-0">
                                <h5 className="modal-title" id="exampleModalLabel">Pending Order View</h5>
