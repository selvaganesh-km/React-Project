    ...
    <AuthLayout>
        ...
        <div className="dashboard-container">
            ...
            <div className="dashboard-main">
                ...
                <div className="superAdmin-transaction-section">
                    ...
                    <div className="transaction-card">
                        <h3 className="section-title">Recent Vendor</h3>
    
                        <div className="transaction-item">
                            <div className="transaction-icon">
                                <img src="https://i.pravatar.cc/100?img=12" alt="Lisa Johnson" />
                            </div>
                            <div className="transaction-content">
                        ...
                        <div className="transaction-item">
                            <div className="transaction-icon">
                                <img src="https://i.pravatar.cc/100?img=11" alt="Michael Torres" />
                            </div>
                            <div className="transaction-content">
