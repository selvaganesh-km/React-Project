        ...
        <div className="collapse navbar-collapse  w-auto sidenav-scrollbar" id="sidenav-collapse-main ">
          {superadminSidebar ?
            <ul className="navbar-nav">
              ...
              <li className="nav-item">
                <Link className={`nav-link ${location.pathname === '/super-admin/profile' ? 'active' : ''}`} to={"/super-admin/profile"}>
                  ...
                  <span className="nav-link-text ms-1">Vendor Profile</span>
                </Link>
              </li>
              <li className="nav-item">
            ...
            <ul className="navbar-nav">
              ...
              <li className="nav-item">
                <Link
                  className={`nav-link ${location.pathname === "/vendor/whatapp-chat" ? "active" : ""
                    }`}
              ...
              <li className="nav-item">
                <Link
                  className={`cursor-pointer nav-link ${["/vendor/sms", "/vendor/whatsapp-template", "/vendor/create-sms", "/vendor/create-whatsapp-template"].includes(location.pathname)
                    ? "active"
                    : ""}`}
                ...
                >
                  ...
                  <li className="nav-item">
                    <Link
                      className={`nav-link ${["/vendor/whatsapp-template", "/vendor/create-whatsapp-template"].includes(location.pathname) ? "active" : ""
                        }`}
              ...
              <li className="nav-item">
                <Link
                  className={`cursor-pointer nav-link ${["/vendor/contacts", "/vendor/contacts/groups"].includes(location.pathname)
                    ? "active"
                    : ""}`}
                ...
                >
                  <li className="nav-item">
                    <Link
                      className={`mt-2 nav-link ${location.pathname === "/vendor/contacts"
                        ? "active"
                        : ""
                        }`}
                      to={"/vendor/contacts"}
              ...
              <li className="nav-item">
                <Link
                  className={`nav-link ${["/vendor/campaign", "/vendor/campaign/dashboard", "/vendor/create-campaign", "/vendor/campaign/create/new", "/vendor/contact/whatsapp/contact/"].some(path => {
                    const isActive = location.pathname.startsWith(path);
                    console.log(`Checking if "${location.pathname}" starts with "${path}": ${isActive}`);
                    return isActive;
                  }) ? "active" : ""}`}
                  to={"/vendor/campaign"}
                >
              ...
              <li className="nav-item">
                <Link
                  className={`cursor-pointer nav-link ${["/vendor/settings/general", "/vendor/settings/whatsapp"].includes(location.pathname)
                    ? "active"
                    : ""}`}
