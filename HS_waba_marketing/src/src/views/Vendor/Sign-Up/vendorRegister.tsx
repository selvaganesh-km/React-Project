                ...
                <div className="card z-index-0">
                  ...
                  <div className="card-body">
                    <form role="form text-left">
                      <div className="row">
                        <div className="mb-3">
                          <input onChange={(e) => setcompanyName(e.target.value)} type="text" className={`form-control loginfilled-frame-username ${submit && !companyName ? 'error' : ''}`} placeholder="Comapny Name" aria-label="Comapny Name" aria-describedby="email-addon" required />
                          {submit && companyName.length == 0 ? <div className='text-danger error-message-required'>Company Name is required</div> : <></>}
                        </div>
                        <div className="mb-3 col-md-6">
                          <input onChange={(e) => setType(e.target.value)} type="email" className={`form-control loginfilled-frame-username ${submit && !type ? 'error' : ''}`} placeholder="Type" aria-label="Type" aria-describedby="email-addon" required />
                          {submit && type.length == 0 ? <div className='text-danger error-message-required'>Category Type is required</div> : <></>}
                        </div>
                        <div className="mb-3 col-md-6">
                          <input onChange={(e) => setAddress(e.target.value)} type="email" className={`form-control loginfilled-frame-username ${submit && !address ? 'error' : ''}`} placeholder="Address" aria-label="Address" aria-describedby="email-addon" required />
                        ...
                        <div className="mb-3 col-md-6">
                          <input onChange={(e) => setEmail(e.target.value)} type="email" className={`form-control loginfilled-frame-username ${submit && !email ? 'error' : ''}`} placeholder="Email" aria-label="Email" aria-describedby="email-addon" required />
                        ...
                        <div className="mb-3">
                          <input onChange={(e) => setuserName(e.target.value)} type="text" className={`form-control loginfilled-frame-username ${submit && !userName ? 'error' : ''}`} placeholder="Username" aria-label="Username" aria-describedby="email-addon" required />
                          {submit && userName.length == 0 ? <div className='text-danger error-message-required'>User Name is required</div> : <></>}
                        </div>
                        <div className="mb-3 col-md-6">
                          <input onChange={(e) => setfirstName(e.target.value)} type="text" className={`form-control loginfilled-frame-username ${submit && !firstName ? 'error' : ''}`} placeholder="First Name" aria-label="First Name" aria-describedby="email-addon" required />
                        ...
                        <div className="mb-3 mt-2 col-md-6">
                          <input onChange={(e) => setlasttName(e.target.value)} type="text" className="form-control" placeholder="Last Name" aria-label="Last Name" aria-describedby="email-addon" />
                        </div>
                        <div className="mb-3 col-md-6">
                          <input onChange={(e) => setusermobileno(e.target.value)} type="email" className={`form-control loginfilled-frame-username ${submit && !usermobileno ? 'error' : ''}`} placeholder="Mobile Number" aria-label="Mobile Number" aria-describedby="email-addon" required />
                          {submit && usermobileno.length == 0 ? <div className='text-danger error-message-required'>Mobile.No is required</div> : <></>}
                        </div>
                        <div className="mb-3 col-md-6">
                          <input onChange={(e) => setuserEmail(e.target.value)} type="email" className={`form-control loginfilled-frame-username ${submit && !userEmail ? 'error' : ''}`} placeholder="Email" aria-label="Email" aria-describedby="email-addon" required />
                        ...
                        <div className="mb-3 col-md-6 vendor-passwordInput">
                          <input onChange={(e) => setPassword(e.target.value)} type={showPassword ? 'text' : 'password'} className={`form-control loginfilled-frame-username ${submit && !password ? 'error' : ''}`} placeholder="Password" aria-label="Password" aria-describedby="password-addon" required />
                        ...
                        <div className="mb-3 col-md-6 vendor-passwordInput">
                          <input onChange={(e) => setconfirmPassword(e.target.value)} type={showConfirmPassword ? 'text' : 'password'} className={`form-control loginfilled-frame-username ${submit && !confirmpassword ? 'error' : ''}`} placeholder="Confirm Password" aria-label="Confirm Password" aria-describedby="password-addon" required />
                          ...
                          <i
                            className={`fas ${showConfirmPassword ? 'fa-eye-slash' : 'fa-eye'} password-eye vendor-passwordInputicon`}
                            id="togglePassword"
