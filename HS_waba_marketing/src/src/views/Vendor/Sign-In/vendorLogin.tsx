                  ...
                  <div className="card card-plain mt-8">
                    ...
                    <div className="card-body">
                      <form role="form">
                        <label>Email</label>
                        <div className="mb-3">
                          <input onChange={(e) => { setEmail(e.target.value); setLoading(false); }} type="email"
                        ...
                        <div className="mb-3 sadmin-passwordInput">
                          <input onChange={(e) => { setPassword(e.target.value); setLoading(false); }} type={showPassword ? 'text' : 'password'}
