...
function VendorStaff() {
   ...
   const handleActiveStaff = (storeId: any) => {
      VendorAPI.staffActiveAPIEP(storeId)
         .then((responseData: any) => {
            if (responseData.apiStatus.code === '200') {
               toast.success(responseData.apiStatus.message);
               handleStaffList(currentPage);
   ...
   const handleImport = async () => {
      ...
      try {
         const response = await API(importStaff, {
            bodyData: formData,
         });
   ...
   const handleExport = async () => {
      try {
         const response = await API(exportStaff, {
         });
                           ...
                           <div className="card-body px-0 pt-0 pb-2">
                              <div className="table-responsive p-0">
                                 <table className="table align-items-center justify-content-center mb-0">
                                    <thead>
                                       <tr>
                                          <th className="staff-table-head text-secondary text-xxs font-weight-bolder opacity-7">Staff Name</th>
                                          <th className="staff-table-head text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Email</th>
                                          <th className="staff-table-head text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Phone</th>
                                          <th className="staff-table-head text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Created At</th>
                                          <th className="staff-table-head text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Status</th>
                                          <th className="staff-table-head text-secondary text-xxs font-weight-bolder text-center opacity-7 ps-2">Action</th>
                                       </tr>
                                    </thead>
                                             ...
                                             <tr>
                                                <td>
                                                   <div className="d-flex px-2">
                                                      ...
                                                      <div className="my-auto">
                                                         <h6 className="mb-0 text-xs">{listData.user_name}</h6>
                                                      </div>
                                                   </div>
                                                </td>
                                                <td>
                                                      ...
                                                      <input className="form-check-input" type="checkbox" id="flexSwitchCheckDefault"
                                                         onClick={() => {
                                                            if (listData.activeStatus === "1") {
                                                               handleDeactiveStaff(listData.id);
                                                            } else if (listData.activeStatus === "0") {
                                                               handleActiveStaff(listData.id);
                                                            }
                                                         }}
                                                ...
                                                <td className="align-middle text-center">
                                                   ...
                                                   <div className="actionDelete-tooltip-container">
                                                      <button className="btn-3 vendorbtn-danger" type="button" data-bs-toggle="modal" onClick={() => { setStaffId(listData.id) }} data-bs-target="#vendordelete">
                                             ...
                                             <div className="row mt-n4">
                                                <div className="col-md-6 login-input-group">
                                                   <div className="vendor-create-container">
                                                      <input onChange={(e) => setStaffName(e.target.value)} value={staffName} type="text" id="vendor-crt-input" className={`vendor-crt-input loginfilled-frame-username ${submit && !staffName ? 'error' : ''}`} placeholder=" " required />
                                                ...
                                                <div className="col-md-6 login-input-group">
                                                   <div className="vendor-create-container">
                                                      <input onChange={(e) => setFirstName(e.target.value)} value={firstName} type="text" id="vendor-crt-input" className={`vendor-crt-input loginfilled-frame-username ${submit && !firstName ? 'error' : ''}`} placeholder=" " required />
                                                ...
                                                <div className="col-md-6 login-input-group">
                                                   <div className="vendor-create-container">
                                                      <input onChange={(e) => setLastName(e.target.value)} value={lastName} type="text" id="vendor-crt-input" className={`vendor-crt-input loginfilled-frame-username`} placeholder=" " required />
                                                      <label htmlFor="vendor-crt-input" className="vendor-crt-label"><i className="fa-solid fa-user"></i> Last Name</label>
                                                   </div>
                                                   {/* {submit && lastName.length == 0 ? <div className='text-danger error-message-required'>Last Name is required</div> : <></>} */}
                                                </div>
                                                <div className="col-md-6 login-input-group">
                                                   <div className="vendor-create-container dropdown" data-bs-toggle="dropdown" aria-expanded="false">
                                                      ...
                                                      <ul className="dropdown-menu storename-dropdown-menu">
                                                         {storeDrop.map((dropdownValue, id) => (
                                                            <li key={id}>
                                                               <a
                                                ...
                                                <div className="col-md-6 login-input-group">
                                                   <div className="vendor-create-container">
                                                      <input onChange={(e) => { setMobileno(e.target.value) }}
                                                         value={mobileno}
                                                         maxLength={15} type="text" id="vendor-crt-input" className={`vendor-crt-input loginfilled-frame-username ${submit && !mobileno ? 'error' : ''}`} placeholder=" " required />
                                                ...
                                                {modalMode === "create" ? <><div className="col-md-6 login-input-group staff-passwordInput">
                                                   <div className="vendor-create-container">
                                                      <input onChange={(e) => setpassword(e.target.value)} value={password} type={showPassword ? 'text' : 'password'} id="vendor-crt-input" className={`vendor-crt-input loginfilled-frame-username ${submit && !password ? 'error' : ''}`} placeholder=" " required />
                                                   ...
                                                   ></i>
                                                      ...
                                                      <div className="vendor-create-container">
                                                         <input onChange={(e) => setconfirmPassword(e.target.value)} value={confirmPassword} type={showConfirmPassword ? 'text' : 'password'} id="vendor-crt-input" className={`vendor-crt-input loginfilled-frame-username ${submit && !confirmPassword ? 'error' : ''}`} placeholder=" " required />
                                                   ...
                                                   <><div className="col-md-6 login-input-group staff-passwordInput">
                                                      <div className="vendor-create-container">
                                                         <input onChange={(e) => setpassword(e.target.value)} value={password} type={showPassword ? 'text' : 'password'} id="vendor-crt-input" className={`vendor-crt-input`} placeholder=" " required />
                                                         <label htmlFor="vendor-crt-input" className="vendor-crt-label"><i className="fa-solid fa-lock"></i> Password</label>
                                                      </div>
                                                      <i
                                                         className={`fas ${showPassword ? 'fa-eye-slash' : 'fa-eye'} password-eye staff-passwordInputicon`}
                                                      ...
                                                      ></i>
                                                         ...
                                                         <div className="vendor-create-container">
                                                            <input onChange={(e) => setconfirmPassword(e.target.value)} value={confirmPassword} type={showConfirmPassword ? 'text' : 'password'} id="vendor-crt-input" className={`vendor-crt-input`} placeholder=" " required />
                                                            <label htmlFor="vendor-crt-input" className="vendor-crt-label"><i className="fa-solid fa-key"></i> Confirm Password</label>
                                                         </div>
                                                         {confirmPassword !== password && confirmPassword.length !== 0 && <div className='text-danger error-message-required'>Password and confirm password should be same</div>}
                                                         <i
                                       ...
                                       <div className="modal-content vendor-delete-content">
                                          ...
                                          <div className="modal-body vendor-delete-body">
                                             <div className="row">
                                                ...
                                                <h4>Are You Sure !</h4>
                                                <h6>You want to delete this staff ?</h6>
                                                <div></div>
                                             </div>
                                          </div>
