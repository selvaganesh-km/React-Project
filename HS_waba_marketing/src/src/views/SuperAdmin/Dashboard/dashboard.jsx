                                 ...
                                 <div class="card-body p-3 position-relative">
                                    <div class="row">
                                       ...
                                       <div class="col-3">
                                          ...
                                          <p class=" text-sm text-end font-weight-bolder mt-auto mb-0">+12%</p>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                                    ...
                                    <tbody>
                                       <tr>
                                          ...
                                          <td class="align-middle text-start text-sm">
                                             <span class="text-xs font-weight-bold">
                                                Daniel D Rajiah<br />9841652232<br />
                                                danieltheddr@gmail.com </span>
                                          </td>
                                       ...
                                       <tr>
                                          <td>
                                             <div class="d-flex px-2 py-1">
                                                <div>
                                                   <img src={AddProgress} class="avatar avatar-sm me-3" alt="atlassian" />
                                                </div>
                                                <div class="d-flex flex-column justify-content-center">
                                       ...
                                       <tr>
                                          <td>
                                             <div class="d-flex px-2 py-1">
                                                <div>
                                                   <img src={FixPlat} class="avatar avatar-sm me-3" alt="team7" />
                                                </div>
                                                <div class="d-flex flex-column justify-content-center">
                                       ...
                                       <tr>
                                          <td>
                                             <div class="d-flex px-2 py-1">
                                                <div>
                                                   <img src={LaunchIcon} class="avatar avatar-sm me-3" alt="spotify" />
                                                </div>
                                                <div class="d-flex flex-column justify-content-center">
